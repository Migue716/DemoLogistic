...
/** Datos estáticos opcionales si no usas la API. */
...
export class MockService {
  ...
  readonly recentShipments: RecentShipment[] = [
  ...
  readonly shipmentByStatus: ShipmentByStatus[] = [
  ...
  readonly shipmentsTable: ShipmentRow[] = [
  ...
  readonly documentsList: DocumentItem[] = [
